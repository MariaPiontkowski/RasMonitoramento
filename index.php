...
<link rel="icon" href="images/icon-rel.png">
		...
		<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav navbar-right">
							<li><a class="hvr-underline-from-center active" href="index.php">Início</a></li>
							<li><a href="services.html" class="hvr-underline-from-center">Serviços</a></li>
...
<!--									<a href="#" data-toggle="modal" data-target="#myModal">Mais Sobre Nosso Serviço</a>-->
<!--								</div>-->
								<div class="bannergrids text-center">
									<div class="col-md-4 grid1">
										<i class="fa fa-truck" aria-hidden="true"></i>
										<p>Monitoramento do veículo em tempo real</p>
									</div>
									<div class="col-md-4 grid1">
										<i class="fa fa-clock" aria-hidden="true"></i>
										<p>Posição atualizadas de minuto em minuto</p>
									</div>
                                    <div class="col-md-4 grid1">
                                        <i class="fa fa-mobile-alt" aria-hidden="true"></i>
                                        <p>Envie comandos de seu smartphone e website</p>
                                    </div>
									<div class="clearfix"></div>
								</div>
							</div>
...
<div class="banner-bottom">
	<div class="col-md-7 bannerbottomleft">
			<div class="video-grid-single-page-agileits">
				<div id="video">
                    <img src="images/bg.png" alt="" class="img-responsive" />
                </div>
			</div>
	</div>
	<div class="col-md-5 bannerbottomright">
		<h3>Como nós trabalhamos?</h3>
		<p>Monitore seu veiculo em tempo real, com posições atualizadas a cada minuto.
            Envie comandos de seu smartphone e website.
            Mais rentabilidade para você.
        </p>
        <h4><i class="text-center fa fa-taxi" aria-hidden="true"></i>Monitoramento</h4>
        <h4><i class="text-center fa fa-lock" aria-hidden="true"></i>Bloqueio</h4>
        <h4><i class="text-center fa fa-wrench" aria-hidden="true"></i>Manutenção</h4>
        <h4><i class="text-center fa fa-chart-pie" aria-hidden="true"></i>Relatórios</h4>
        <h4><i class="text-center fa fa-chart-line" aria-hidden="true"></i>Cerca Virtual</h4>
	</div>
	<div class="clearfix"></div>
</div>
<!-- //banner-bottom -->
		...
		<div class="agileits-w3layouts-footer">
				...
				<div class="col-md-12 w3-agile-grid">
					...
					<div class="w3-address">
						<div class="col-md-6 w3-address-grid">
						...
						<!--<div class="col-md-4 w3-address-grid">
							<div class="w3-address-left">
